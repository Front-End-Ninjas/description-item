    ...
    <div>
      <p id="price_shipping">Price: <span id="price"> ${dataDesc.price}</span>
        <span id="shipping"> {dataDesc.shipping === 'Prime' ?
          <img src="http://nileproductdescription-env.zkb3gk9nqy.us-west-1.elasticbeanstalk.com/prime_logo.png" alt="Amazon Prime" /> :
          <span> & {dataDesc.shipping}.</span>}
        </span>
      </p>
    </div>
    <div>
      <h3 id="stock">{dataDesc.stock ? <span id="in">In Stock.</span> :
      <span id="out">Temporarily Out of Stock.</span>}
      </h3>
    </div>
    <div id="list_desc">
